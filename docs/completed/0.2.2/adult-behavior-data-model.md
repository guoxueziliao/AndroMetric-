...
> 本文件是 0.2.2 刀 40 的总览入口。详细契约已拆到同目录下的专题文档，避免单个文档过长。0.2.2 代码实现当前已完成，本文保留为实现依据。
...
- 状态：实现依据 / 0.2.2 代码实现已完成。
- 刀 40 已完成：产品决策已转换为可实现的数据模型契约。
- 刀 41 - 刀 49 已完成：schema / migration / domain types、storage、import/export、snapshot integrity、事件模型、UI、关联和基础复盘。
- 发布前仍需按真实代码状态复核版本收口、测试结果和文档归档。
