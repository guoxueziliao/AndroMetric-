...
> 本目录承载 0.2.2 成人行为与色情使用记录闭环的专题文档和执行拆解。根入口仍是 [`../plan-0.2.2.md`](../plan-0.2.2.md)。
...
- [刀 41](./knife-41.md)：schema / migration / domain types。
- [刀 42](./knife-42.md)：storage / import-export / snapshot integrity。
- [刀 43](./knife-43.md)：Porn use event model + tests。
- [刀 44](./knife-44.md)：Masturbation event alignment。
- [刀 45](./knife-45.md)：Sex event mapping / adapter。
- [刀 46](./knife-46.md)：UI entry points + minimal forms。
- [刀 47](./knife-47.md)：Event linking UI。
- [刀 48](./knife-48.md)：Basic review loop。
- [刀 49](./knife-49.md)：Golden path + docs + version close。
