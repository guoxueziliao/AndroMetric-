...
import { Moon, Zap, Activity, Hand, HeartPulse, Clock, Dumbbell, Footprints, Timer, CloudSun, Beer, TrendingUp, ShieldAlert, Edit3, Trash2, FastForward, Coffee, Bed, ArrowRight, User, Heart, RotateCcw, MapPin, Sparkles, Shirt, Star, Thermometer, BrainCircuit, Tag, Film, Smile, AlertTriangle, ChevronRight, Calendar, Check, AlertCircle, Sofa, X, Pill } from 'lucide-react';
...
import SupplementCycleBar from './SupplementCycleBar'; // New
    ...
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-end px-2">
            ...
            <div className="w-10 h-10 bg-brand-card dark:bg-slate-900 rounded-full shadow-sm flex items-center justify-center border border-slate-100 dark:border-white/5">
                                        ...
                                        {summaryLog.supplementIntake.map(i => {
                                            ...
                                            return (
                                                <div key={i.supplementId} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                                                    ...
                                                    <span className="text-[10px] opacity-50">{i.dosage || def?.dosage}</span>
                                                </div>
                                            );
                                        })}
                                    </div>
