                                ...
                                return (
                                    <div 
                                        ...
                                        className={`flex-1 rounded-full transition-all duration-500 ${
                                            isCurrent ? 'ring-2 ring-offset-1 ring-slate-400 dark:ring-offset-slate-900' : ''
                                        } ${
                                            isSupDay ? (isCurrent || idx < dayInCycle ? 'opacity-100' : 'opacity-20') : 'bg-slate-200 dark:bg-slate-800'
                                        }`}
