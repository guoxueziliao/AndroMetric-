...
/* Added Pill to fix missing icon for supplement category */
...
/* Added supplement icon to satisfy Record<HistoryCategory, ...> constraint */
...
/* Added supplement label to satisfy Record<HistoryCategory, ...> constraint */
