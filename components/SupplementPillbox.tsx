    ...
    return (
        <div className="space-y-3">
            <div className="flex items-center gap-2 px-1">
                ...
                <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest">今日补剂 (PILLBOX)</label>
            </div>
                ...
                {activeSupplements.map(sup => {
                    ...
                    return (
                        <button
                            ...
                            className={`relative p-4 rounded-[1.5rem] border-2 transition-all flex flex-col items-center gap-2 group active:scale-95 ${
                                isTaken 
                                ? `bg-white dark:bg-slate-900 shadow-md border-[${sup.color}] ring-2 ring-[${sup.color}]/10` 
                        ...
                        >
                            ...
                            <div className="text-center">
                                <div className={`text-xs font-black truncate max-w-[80px] ${isTaken ? 'text-slate-800 dark:text-slate-100' : 'text-slate-400'}`}>{sup.name}</div>
