...
const NavItem: React.FC<{
  ...
  return (
    ...
    >
      <div className={`p-2 rounded-2xl transition-all duration-300 ${isActive ? 'bg-blue-50 dark:bg-blue-500/10 scale-105' : ''}`}>
...
const BottomNav: React.FC<BottomNavProps> = ({ activeView, onViewChange }) => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border-t border-slate-200/50 dark:border-slate-800/50">
      {/* 主导航容器：高度适度降低 */}
