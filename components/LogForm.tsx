...
import { LogEntry, PartnerProfile, AlcoholRecord, CaffeineItem, SupplementIntake } from '../types';
                                        ...
                                        <div key={record.id} className="group flex justify-between items-center bg-white dark:bg-slate-800 p-3.5 rounded-2xl border border-slate-100 dark:border-white/5 shadow-sm">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[10px] text-slate-400 font-bold mt-0.5">{record.items.map(i => i.name).join(', ')} · {record.time}</div>
                                                </div>
                                            </div>
